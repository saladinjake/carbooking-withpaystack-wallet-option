  ...
  interventions: [
    {
      ...
      phone_number: '08068291106',
      response:
        'Dear User, your ticket has been marked as reviewed and the service team are working on it',
      assigned_to: 'saladin',
    },
  ...
  faqs: [
    {
      ...
      answer:
        'Click on forget password link and enter your email.<br/> An email would be sent to you to activate your new password',
    },
    {
      id: 2,
      question: 'How do i request for a cab?',
      answer:
        'After logging in to our platform, click on the plan link on the left side navigation and click on create plan. Follow the steps available for you until you hit the request quote button. After successful entry of your itineries a mail would be sent to you.',
    },
  ...
  previledgesA: [
...

    {
      ...
      previledges_description:
        'Description for this admin has few previledges lower than the super admin',
    },
