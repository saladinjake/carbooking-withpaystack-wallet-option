...
var _default = {
  ...
  cars: [{
    ...
    manufacturer: 'Hyundai'
  }, _defineProperty(_ref, "inspectionDate", '12/12/12'), _defineProperty(_ref, "inspectionTime", '12:02:AM'), _defineProperty(_ref, "carDescription", "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer eget lectus a sem dapibus dignissim. Etiam eget mauris sollicitudin, elementum lectus id, sagittis lorem. Integer ac consequat ipsum, id tincidunt velit. Nam nunc velit, molestie a euismod quis, consectetur ut massa. Nunc libero elit, posuere eu nisl tempor, vehicula rutrum arcu. Integer imperdiet nisl in turpis convallis gravida. Sed dictum venenatis vehicula. Aliquam erat volutpat. Curabitur ac ante ac leo mattis porta.\n\nDuis sit amet neque eu nunc tempus eleifend. In cursus euismod dui vitae fermentum. Etiam tempus consectetur imperdiet. Nullam purus nulla, fringilla quis eleifend quis, vestibulum sit amet risus. Mauris at blandit nulla, ac dapibus dui. Aliquam auctor consectetur tristique. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi imperdiet viverra turpis, ac ultricies nunc eleifend vitae. Nunc nec massa nec ligula consectetur sagittis vitae eget nulla."), _defineProperty(_ref, "imagePath", 'https://commute-bucket.s3.amazonaws.com/car2.jpg'), _defineProperty(_ref, "creator", 'hddddddsdsds'), _defineProperty(_ref, "date_created", new Date()), _defineProperty(_ref, "partnerEmail", 'juwavictor@gmail.com'), _defineProperty(_ref, "car_type", 'Black jack'), _defineProperty(_ref, "car_year", '2012'), _defineProperty(_ref, "color", 'white'), _defineProperty(_ref, "model", 'abarth'), _defineProperty(_ref, "model_make_id", 'abarth'), _defineProperty(_ref, "description", 'dummy description for this car'), _defineProperty(_ref, "inspection_detail", 'CMT-INSP-9943043'), _defineProperty(_ref, "partner_id", 'CMT-PARTNER-12345'), _defineProperty(_ref, "car_status", 'Active'), _defineProperty(_ref, "health_status", 'Completed'), _defineProperty(_ref, "status", 'Available'), _defineProperty(_ref, "images", 'https://commute-bucket.s3.amazonaws.com/car2.jpg'), _defineProperty(_ref, "license", 'jdjsjds'), _defineProperty(_ref, "plate_number", '328ds9-32x'), _defineProperty(_ref, "isOwnedByCompany", false), _defineProperty(_ref, "price", "80000"), _defineProperty(_ref, "assigned_driver_id", '1'), _defineProperty(_ref, "assigned_driver_name", 'saladin'), _defineProperty(_ref, "assigned_driver_email", 'juwavictor@gmail.com'), _defineProperty(_ref, "assigned_driver_location", '6.5355, 3.3087'), _defineProperty(_ref, "assigned_driver_phone", '08068291106'), _defineProperty(_ref, "socket_id", 'default-id'), _ref), {
    id: 3,
    car: {
      car_name: 'Hyundai Santa Fe Limited 4dr SUV AWD (3.3L 6cyl 6A) 2017',
      model_id: '71129',
  ...
  drivers: [{
    ...
    isVerified: true,
    avatar: 'saladinjake.jpg'
  }, _defineProperty(_ref2, "roles", "Individual Driver"), _defineProperty(_ref2, "balance", "0.00"), _defineProperty(_ref2, "identity_card", "ireoireroiieoroie"), _defineProperty(_ref2, "test_certificate", "hfdhjhfhdfhd"), _defineProperty(_ref2, "notification_count", 0), _defineProperty(_ref2, "status", "Active"), _defineProperty(_ref2, "car_assigned_name", 'Morris'), _defineProperty(_ref2, "assigned_car_plate_number", '328ds9-32x'), _defineProperty(_ref2, "location", {
    type: "Point",
