...
window.updateInspectionAction = (o) =>{
        ...
        let linkOfApi = "https://demouserapp.commute.ng:12000/api/v1" + o.dataset.url + '/' + o.dataset.id
    ...
    if(el.dataset.minspection=="yes"){
     ...
     save.addEventListener('click', function(e){
      e.preventDefault()
        ...
        const user =JSON.parse(localStorage.getItem("userToken"));
        let linkOfApi = 'https://demouserapp.commute.ng:12000/api/v1/admin-previledges-update/'+ el.dataset.id  ;
...
window.RolesAddAction = (t) =>{
 ...
 let linkOfApi ='https://demouserapp.commute.ng:12000/api/v1/' + t.dataset.url ;
...
window.RolesUpdateAction =(t) =>{
 ...
 let linkOfApi ='https://demouserapp.commute.ng:12000/api/v1/' + t.dataset.url + '/' + t.dataset.id
