...
class IReporterWebsiteRepairs {
  ...
  singleItemPageController() {
    ...
    documentDom.addEventListener(
      'click',
      e => {
        if (CarRepairs.hasClass(e.target, 'read_more')) {
  ...
  saveNewRecordPageController() {
    ...
    documentDom.addEventListener(
      'click',
      e => {
        if (CarRepairs.hasClass(e.target, 'new_content')) {
  ...
  deleteRecordPageController() {
    ...
    document.addEventListener(
      ...
      function(e) {
        e.preventDefault();
        if (CarRepairs.hasClass(e.target, 'delete_icon')) {
  ...
  editStatusRecordPageController() {
    ...
    document.addEventListener(
      'click',
      function(e) {
        if (CarRepairs.hasClass(e.target, 'update_status_icon')) {
          let dataPromise = InterventionModel.getSpecificData();
          dataPromise.then(data => {
