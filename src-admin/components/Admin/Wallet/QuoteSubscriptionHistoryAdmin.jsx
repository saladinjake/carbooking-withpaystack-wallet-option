...
export  default class QuoteSubscriptionHistoryAdmin extends Component {
  ...
  render() {
    ...
    <div className="content-page" id="first-view">
        ...
        <div className="content" id="admin" data-pageid="admin-quotations">
                      ...
                      <div className="row">
                        ...
                        <div className="col-sm-6 text-lg-center text-right pull-right">
                          <div className="form-group">
                              <input id="search" type="text" placeholder="Enter Plan ID..." className="form-control input-sm product-search" autocomplete="on" />
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div className="content">
                <div className="container" >
                    ...
                    <div className="row">
                            ...
                            <div className="col-lg-8"><h4 className="m-b-10 header-title">Quotation Detail<span className="m-l-10 text-purple font-13"><b id="user-id"></b></span></h4></div>
