	  ...
	  return (
       ...
       <div className="content-page">
            ...
            <div className="content">
                <div className="container" id="admin" data-pageid="admin-drivers-detail">
                    ...
                    <div className="row">
                            ...
                            <div className="col-lg-8"><h4 className="m-b-10 header-title">Driver Detail <span className="m-l-10 text-purple font-13"><b>CMUSER2020003</b></span></h4></div>
                            ...
                            <div className="col-lg-6 m-t-10" >
                                <div className="card-box">
                                    ...
                                    <form className="form-horizontal" role="form" data-parsley-validate noValidate>
                                        ...
                                        <div className="form-group col-sm-12">
                                            <label htmlFor="" className="col-sm-4 control-label">First Name</label>
                                            <div className="col-sm-7">
                                                <input type="text" required disabled parsley-type="text" className="form-control" id="" value="John" />
                                            </div>
                                        </div>
    
                                        <div className="form-group col-sm-12">
                                            <label htmlFor="" className="col-sm-4 control-label">Last Name</label>
                                            <div className="col-sm-7">
                                                <input type="text" required disabled parsley-type="text" className="form-control" id="" value="Dumelo" />
                                            </div>
                                        </div>
                                        ...
                                        <div className="form-group col-sm-12">
                                            ...
                                            <div className="col-sm-7">
                                                <input type="text" required disabled parsley-type="text" className="form-control" id="" value="John Dumelo" />
                                            </div>
                                        </div>

                                        <div className="form-group col-sm-12">
                                                <label htmlFor="inputEmail3" className="col-sm-4 control-label">Email Address</label>
                                                <div className="col-sm-7">
                                                    <input type="email" required parsley-type="email" className="form-control" id="inputEmail3" value="john.dumelo@email.com" />
                                                </div>
                                            </div>

                                        <div className="form-group col-sm-12">
                                            <label htmlFor="" className="col-sm-4 control-label">Assigned Car</label>
                                            <div className="col-sm-7">
                                                <input type="text" required parsley-type="text" className="form-control" id="" value="VG 309 RTL" />
                                            </div>
                                        </div>
