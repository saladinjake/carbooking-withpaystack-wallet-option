  ...
  bootstrap() {
    ...
    if(localStorage.getItem("userToken")){
      ...
      window.onload= function(){
        ...
        const urls = ["https://demouserapp.commute.ng:12000/api/v1"+"/balance/"+ user.user.email, 
                      "https://demouserapp.commute.ng:12000/api/v1"+"/notification/"+ user.user.email
                      ];
...
window.updateNotificationStatus = (el) =>{
  ...
  const user = JSON.parse(localStorage.getItem("userToken"));
  let url = "https://demouserapp.commute.ng:12000/api/v1"+"/notification/"+ el.dataset.id
