	  ...
	  return (
       ...
       <div className="content-page">
            ...
            <div className="content">
                <div className="container" id="admin" data-pageid="admin-users-detail">
                                ...
                                <div className="card-box">
                                    ...
                                    <form className="form-horizontal" role="form" data-parsley-validate noValidate>
                                        ...
                                        <div className="form-group col-sm-12">
                                            ...
                                            <div className="col-sm-7">
                                                <input type="text" required parsley-type="text" className="form-control" id="" value="Jane" />
                                            </div>
                                        </div>
                                        ...
                                        <div className="form-group col-sm-12">
                                            ...
                                            <div className="col-sm-7">
                                                <input type="text" required parsley-type="text" className="form-control" id="" value="Doe" />
                                            </div>
                                        </div>
                                        ...
                                        <div className="form-group col-sm-12">
                                            ...
                                            <div className="col-sm-7">
                                                <input type="text" required parsley-type="text" className="form-control" id="" value="Jane Doe" />
                                            </div>
                                        </div>
                                        ...
                                        <div className="form-group col-sm-12">
                                                ...
                                                <div className="col-sm-7">
                                                    <input type="email" required parsley-type="email" className="form-control" id="inputEmail3" value="jane.doe@email.com" />
                                                </div>
                                            </div>

                                        <div className="form-group col-sm-12">
                                            <label for="" className="col-sm-4 control-label">User Certificate </label>
                                            <div className="col-sm-7">
                                                <input type="text" required parsley-type="text" className="form-control" id="" value="CM-USER-CERT-2020005" />
                                            </div>
                                        </div>

                                        <div className="form-group col-sm-12">
                                                <label for="amount" className="col-sm-4 control-label">Wallet Balance </label>
                                                <div className="col-sm-7">
                                                        <input type="text" required disabled parsley-type="text" className="form-control" value="20,000" />
                                                    </div>
                                        </div>
