  ...
  attachEvents() {
    ...
    if((!document.getElementById('signup_page') && !document.getElementById('loginpage') && !document.getElementById('pass_forgot_page') )){
      if(user.user.profile){
        document.getElementById("user-profile").src="https://commute-bucket.s3.amazonaws.com/"+ user.user.profile
    ...
    if (document.getElementById('profile-page')) {
     if(user.user.profile){
       document.getElementById("preview").src="https://commute-bucket.s3.amazonaws.com/"+ user.user.profile
      }else{
