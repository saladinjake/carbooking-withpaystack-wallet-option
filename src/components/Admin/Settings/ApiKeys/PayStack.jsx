      ...
      <React.Fragment>
       ...
       <div className="content-page" id="first-view">
            ...
            <div className="content">
                <div className="container" id="admin"  data-pageid="admin-settings-paystack">
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="card-box">
                                <h4 className="m-t-0 header-title"><b>Paystack Api Settings</b></h4>
                ...
                <div className="container" >
                    ...
                    <div className="row">
                           ...
                           <div className="col-lg-12 card-box">
                            ...
                            <div className="col-lg-8"><h4 className="m-b-10 header-title">Paystack Api Detail <span className="m-l-10 text-purple font-13"><b id="user-id"></b></span></h4></div>
