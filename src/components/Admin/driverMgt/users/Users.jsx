      ...
      <React.Fragment>
        ...
        <div className="content-page" id="first-view">
            ...
            <div className="content">
                <div className="container" id="admin" data-pageid="admin-drivers">
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="card-box">
                                <h4 className="m-t-0 header-title"><b>Drivers Management</b></h4>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-sm-4">
                                        <a href="#custom-modal" id="add-new"
                                            ...
                                            data-overlayColor="#36404a"><i className="md md-add"></i> Add Driver</a>
                                    </div>
                                </div>
            ...
            <div className="content">
                <div className="container" >
                    ...
                    <div className="row">
                            ...
                            <div className="col-lg-8"><h4 className="m-b-10 header-title">Driver Detail <span className="m-l-10 text-purple font-13"><b id="user-id"></b></span></h4></div>
