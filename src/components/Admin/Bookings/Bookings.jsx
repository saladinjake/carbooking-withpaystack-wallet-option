      ...
      <React.Fragment>
        ...
        <div className="content-page" id="first-view">
            ...
            <div className="content">
                <div className="container" id="admin" data-pageid="admin-bookings">
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="card-box">
                                <h4 className="m-t-0 header-title"><b>Plan Booking Management</b></h4>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-sm-4">
                                        <a href="./admin-manual-booking"
                                            className="btn btn-default btn-md waves-effect waves-light m-b-30"
                                            ><i className="md md-add"></i> Add Manual Booking</a>
                                    </div>
                                </div>
