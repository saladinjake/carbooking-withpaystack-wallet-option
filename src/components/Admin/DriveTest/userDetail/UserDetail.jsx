...
export  default class DriveTestDetail extends Component {
	  ...
	  return (
       ...
       <div className="content-page">
            ...
            <div className="content">
                <div className="container" id="admin" data-pageid="admin-drive-test-add">
                    ...
                    <div className="row">
                            ...
                            <div className="col-lg-8"><h4 className="m-b-10 header-title">Add Drive Test <span className="m-l-10 text-purple font-13"><b></b></span></h4></div>
                                ...
                                <div className="card-box">
                                    ...
                                    <form className="form-horizontal" role="form" data-parsley-validate noValidate>
                                        ...
                                        <div className="form-group col-sm-12">
                                         ...
                                         <div className="form-group col-sm-12">
                                            <label htmlFor="" className="col-sm-4 control-label">Email</label>
                                            <div className="col-sm-7">
                                        ...
                                        <div className="form-group col-sm-12">
                                            <label htmlFor="" className="col-sm-4 control-label">Username </label>
                                            <div className="col-sm-7">
                                        ...
                                        <div className="form-group col-sm-12">
                                            <label htmlFor="" className="col-sm-4 control-label">Date</label>
                                            <div className="col-sm-7">
                                        ...
                                        <div className="form-group col-sm-12">
                                                <label htmlFor="inputEmail3" className="col-sm-4 control-label">Test Center</label>
                                                <div className="col-sm-7">
                                                    <input type="text" required parsley-type="email" className="form-control" id="time"  />
                                                </div>
                                            </div>

                                        <div className="form-group col-sm-12">
                                            <label htmlFor="" className="col-sm-4 control-label">Address of Drive Test Center</label>
                                            <div className="col-sm-7">
