       ...
       <React.Fragment>
        ...
        <div className="content-page" id="first-view">
            ...
            <div className="content">
                <div className="container" id="admin" data-pageid="admin-users">
            ...
            <div className="content">
                <div className="container" >
                    ...
                    <div className="row">
                            ...
                            <div className="col-lg-8"><h4 className="m-b-10 header-title">User Detail <span className="m-l-10 text-purple font-13"><b id="user-id"></b></span></h4></div>
