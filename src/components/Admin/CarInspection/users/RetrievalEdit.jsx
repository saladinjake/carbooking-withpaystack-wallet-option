...
export  default class RetrievalEdit extends Component {
	  ...
	  return (
        ...
        <div className="content-page" id="first-view">
            ...
            <div className="content">
                <div className="container" id="admin" data-pageid="view-retrievals">
                            ...
                            <div className="card-box">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-sm-4" >
                                        <a href="./admin-car-request" 
                                            className="btn btn-default btn-md waves-effect waves-light m-b-30"
                                           ><i className="md md-add"></i> Create Request</a>
                                    </div>
                                </div>
            ...
            <div  className="content-page" id="second-view">
                    ...
                    <div className="row">
                            ...
                            <div className="col-lg-6 m-t-10" >
                                <div className="card-box">
                                     ...
                                     <div style={{display:"block"}} id="modalbody1"></div>
